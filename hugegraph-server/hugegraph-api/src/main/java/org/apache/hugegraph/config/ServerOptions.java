...
public class ServerOptions extends OptionHolder {
    ...
    public static final ConfigOption<String> VERMEER_SERVER_TOKEN_FACTOR =
            new ConfigOption<>(
                    "vermeerserver.token_factor",
                    "The factor of Vermeer token generation.",
                    disallowEmpty(),
                    "IAmVermeerN0TWarrior"
            );
    ...
    public static final ConfigListOption<String> K8S_ALGORITHMS =
            new ConfigListOption<>(
                    ...
                    "K8s algorithms",
                    disallowEmpty(),
                    "page-rank:com.baidu.hugegraph.computer.algorithm.centrality.pagerank" +
                    ".PageRankParams",
                    "degree-centrality:com.baidu.hugegraph.computer.algorithm.centrality.degree" +
                    ".DegreeCentralityParams",
                    "wcc:com.baidu.hugegraph.computer.algorithm.community.wcc.WccParams",
                    "triangle-count:com.baidu.hugegraph.computer.algorithm.community" +
                    ".trianglecount.TriangleCountParams",
                    "rings:com.baidu.hugegraph.computer.algorithm.path.rings.RingsDetectionParams",
                    "rings-with-filter:com.baidu.hugegraph.computer.algorithm.path.rings.filter" +
                    ".RingsDetectionWithFilterParams",
                    "betweenness-centrality:com.baidu.hugegraph.computer.algorithm.centrality" +
                    ".betweenness.BetweennessCentralityParams",
                    "closeness-centrality:com.baidu.hugegraph.computer.algorithm.centrality" +
                    ...
                    "louvain:com.baidu.hugegraph.computer.algorithm.community.louvain" +
                    ".LouvainParams",
                    "clustering-coefficient:com.baidu.hugegraph.computer.algorithm.community.cc" +
                    ".ClusteringCoefficientParams",
                    "ppr:com.baidu.hugegraph.computer.algorithm.centrality.ppr" +
                    ".PersonalPageRankParams",
                    "subgraph-match:com.baidu.hugegraph.computer.algorithm.path.subgraph" +
                    ".SubGraphMatchParams"
            );
